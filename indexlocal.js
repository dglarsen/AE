...
function tileLayerFactory(site) {
  ...
  return new TileLayer({
    ...
    source: new TileWMS({
      ...
      url: "https://192.168.1.67:8443/geoserver/TallCree_2751/wms",
      attributions:
...
var vectorLayer2 = new VectorLayer({
  source: new VectorSource({
    url: 'https://192.168.1.67:8443/geoserver/focusedgeo_postgis/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=focusedgeo_postgis:TallCree_SiteList&maxFeatures=50&outputFormat=application/json&srsname=EPSG:26911',
    format: new GeoJSON(),
  }),
...
var vectorSource = new VectorSource({
  format: new GeoJSON(),
  url:
    "https://192.168.1.67:8443/geoserver/focusedgeo_postgis/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=focusedgeo_postgis:TallCree_SiteList&maxFeatures=50&outputFormat=application/json&srsname=EPSG:26911"
});
...
colorScaleControl38.setName("<u>InPhase:</u> ");
